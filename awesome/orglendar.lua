...
-- taken from https://github.com/alexander-yakushev/Orglendar
-- and https://awesome.naquadah.org/wiki/Orglendar_widget
...
local orglendar = { files = {},
                    ...
                    font = theme.font or 'DejaVuSansMono 10',
                    parse_on_show = true,
...
local function create_calendar()
   ...
   -- for week to start on Monday
   -- local first_day_in_week = (os.date("%w", first_day) + 6) % 7
