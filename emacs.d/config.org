...
(use-package org
  ...
  (setq org-refile-targets (quote ((nil :maxlevel . 3)
                                ((concat org-directory "journal.org") :maxlevel . 3)
                                ((concat org-directory "todo.org") :maxlevel . 2))))
  ...
  ;; Agenda files
  (setq org-agenda-files '("~/nextcloud/caldav.org"
...
#+BEGIN_SRC emacs-lisp
  (setq org-capture-templates
      '(("t" "Task" entry (file (lambda () (concat org-directory "todo.org")))
          "* TODO %?\n  %U\n%a\n%i" :clock-in t :clock-resume t)

        ("j" "Journal Entry" entry (file+olp+datetree (file (lambda () (concat org-directory "journal.org")))
...
#+BEGIN_SRC emacs-lisp
  ...
  (defconst smtp-from-server-alist
    '(
      ...
      ("Oscar Najera <on@mathias-kettner.de>" . ("mail.mathias-kettner.de" 25 starttls))
