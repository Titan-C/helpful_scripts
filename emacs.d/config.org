...
#+BEGIN_SRC emacs-lisp
  ...
  ;; my lisps or from other sources
...
;; this will be integrated in Emacs 26 under auth-source-pass
...
#+BEGIN_SRC emacs-lisp
  (use-package org-gcal
    :config
    (setq org-gcal-client-id (password-store-get "google/emacs-gcal-client")
          org-gcal-client-secret (password-store-get "google/emacs-gcal-client-secret")
...
(funcall (plist-get (car (auth-source-search :host "google" :user "najera.oscar")) :secret))
(setq org-caldav-url "https://oscar@cloud.najera.pw/remote.php/dav/calendars/oscar")
(setq org-caldav-calendar-id "personal")
(setq org-caldav-inbox "~/ownCloud/caldav.org")
(setq org-caldav-files '("~/ownCloud/input.org"))
...
#+BEGIN_SRC emacs-lisp
  (setq org-capture-templates
      '(("t" "Task" entry (file "~/Dropbox/org/todo.org")
        ...
        ("l" "Lab Journal Entry" entry
              (file+olp+datetree "~/Dropbox/org/PHD_Journal.org")
              "* %(format-time-string \"%H:%M\") %?\n%a\n%i"
              :clock-in t :clock-resume t)

        ("p" "Web site quote" entry (file+headline (lambda () (concat org-directory "/webnotes.org")) "Inbox")
            "* %a \nCaptured On: %U \nWebsite: %l\n#+BEGIN_QUOTE\n%i\n#+END_QUOTE"
            :clock-in t :clock-resume t)

        ("L" "Website Link" entry (file+headline (lambda () (concat org-directory "/webnotes.org")) "Index")
         "* %a
:PROPERTIES:
:CREATED: %U
:END:\n
...
#+BEGIN_SRC emacs-lisp
  ...
  (defconst smtp-from-server-alist
    '(("Oscar Najera <hello@oscarnajera.com>" . ("mail.najera.pw" 587 starttls "hi"))
      ("Oscar Najera <hi@oscarnajera.com>" . ("mail.najera.pw" 587 starttls "hi"))
