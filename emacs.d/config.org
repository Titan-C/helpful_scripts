...
#+BEGIN_SRC emacs-lisp
  (setq org-capture-templates
      '(("t" "Task" entry (file "~/Dropbox/org/todo.org")
        ...
        ("p" "Protocol" entry (file+headline (lambda () (concat org-directory "/webnotes.org")) "Inbox")
          "* %a \nCaptured On: %U \nWebsite: %l\n#+BEGIN_QUOTE\n%i\n#+END_QUOTE")

        ("L" "chii" entry (file+headline (lambda () (concat org-directory "/webnotes.org")) "index")
         "* %a
  :PROPERTIES:
  :CREATED: %U
  :END:\n
